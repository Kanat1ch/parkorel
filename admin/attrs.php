...
<head>
    ...
    <title>Аттракционы | Администратор ГПКиО</title>
...
<body>
    <header class="header">
        ...
        <div class="page-title">Аттракционы</div>
        ...
        <div class="wrapper">
            <div class="posts">
                ...
                <div class="posts__item">
                    <div class="image">
                        <img src="img/attr/<?=$attr['img']?>" alt="image">
                    </div>
                    <div class="content">
                        <a href="attr_edit.php?attr_id=<?=$attr['id'];?>"><?=$attr['title']?></a>
                    </div>
                    <div class="options">
                        ...
                        <div class="click-handler">
                            <div class="options-list">
                                <div class="option edit">
                                    ...
                                    <a href="attr_edit.php?attr_id=<?=$attr['id'];?>">Редактировать</a>
                                </div>
                                <div class="option add-image">
                                    <div class="icon"><img src="img/icons/image.png" alt="icon"></div>
                                    <a href="attr_upload.php?attr_id=<?=$attr['id'];?>">Добавить изображение</a>
                                </div>
                                <div class="option delete">
                                    <div class="icon"><img src="img/icons/delete.png" alt="icon"></div>
                                    <a href="attr_del.php?del_attr=<?=$attr['id'];?>">Удалить</a>
                                </div>
                            </div>
                        </div>
                    </div>
