...
{
		if(empty($_POST['p_title'])||empty($_POST['p_about']))
		{	
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO posts(title, content, img, f1) VALUE('".$_POST['p_title']."','".$_POST['p_about']."','".$fnew."','".$fnew."')";
        ...
        <div class="col-lg-12">
            <div class="card card-outline-primary">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Добавить пост</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-danger">
                                        ...
                                        <textarea id="mytextarea" name="p_about" class="form-control form-control-danger"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
