...
<head>
    ...
    <title>Клубы | Администратор ГПКиО</title>
        ...
        <div class="wrapper">
            <div class="posts">
                ...
                <div class="posts__item">
                    <div class="image">
                        <img src="img/clubs/<?=$club['img']?>" alt="image">
                    </div>
                    <div class="content">
                        <a href="club_edit.php?club_id=<?=$club['id'];?>"><?=$club['title']?></a>
                    </div>
                    <div class="options">
                        ...
                        <div class="click-handler">
                            <div class="options-list">
                                <div class="option edit">
                                    ...
                                    <a href="club_edit.php?club_id=<?=$club['id'];?>">Редактировать</a>
                                </div>
                                <div class="option add-image">
                                    <div class="icon"><img src="img/icons/image.png" alt="icon"></div>
                                    <a href="club_upload.php?club_id=<?=$club['id'];?>">Добавить изображение</a>
                                </div>
                                <div class="option delete">
                                    <div class="icon"><img src="img/icons/delete.png" alt="icon"></div>
                                    <a href="club_del.php?del_club=<?=$club['id'];?>">Удалить</a>
                                </div>
                            </div>
                        </div>
                    </div>
