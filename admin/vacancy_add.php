...
<head>
    ...
    <title>Добавить вакансию | Администратор ГПКиО</title>
</head>
<body>
    <header class="header">
    ...
    <nav class="navbar">
        ...
        <div class="navbar__item active">
            ...
            <a href="vacancy_add.php" class="add-new"><img src="img/icons/plus_active.png" alt="add-new"></a>
        </div>
        <div class="navbar__item">
        ...
        <div class="wrapper">
            <form class="form" action='' method='post' enctype="multipart/form-data">
                <div class="form__item short-form">
                    ...
                    <input type="text" name="v_title" id="title">
                </div>
                <div class="form__item short-form">
                    <label for="price">Заработная плата</label>
                    <input type="number" name="v_price" id="price">
                    <div class="fixed-value">руб.</div>
                </div>
                <div class="form__item">
                    <label for="claim">Требования</label>
                    <textarea name="v_claim" id="claim"></textarea>
                </div>
                <div class="form__item">
                    <label for="obligation">Обязанности</label>
                    <textarea name="v_obligation" id="obligation"></textarea>
                </div>
                <div class="form__item">
