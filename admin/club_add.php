					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO clubs(title, director, phone, content, img) VALUE('".$_POST['c_title']."','".$_POST['c_director']."','".$_POST['c_phone']."','".$_POST['c_content']."','".$fnew."')";
        ...
        <div class="col-lg-12">
            <div class="card card-outline-primary">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Добавить клуб</h4>
                </div>
                <div class="card-body">
