...
if(isset($_POST['submit'])) {
    ...
    if($extension == 'jpg'||$extension == 'png'||$extension == 'gif') {        
        if ($fsize>=1000000) {
            ...
            $sql = "INSERT INTO clubs(title, scontent, director, phone, content, img) VALUE('".$_POST['c_title']."','".$_POST['c_scontent']."','".$_POST['c_director']."','".$_POST['c_phone']."','".$_POST['c_content']."','".$fnew."')";            mysqli_query($link, $sql); 
...
<head>
    ...
    <title>Добавить клуб | Администратор ГПКиО</title>
</head>
<body>
    <header class="header">
    ...
    <nav class="navbar">
        ...
        <div class="navbar__item active">
            ...
            <a href="club_add.php" class="add-new"><img src="img/icons/plus_active.png" alt="add-new"></a>
        </div>
        <div class="navbar__item">
        ...
        <div class="wrapper">
            <form class="form" action='' method='post' enctype="multipart/form-data">
                ...
                <div class="form__item">
                    ...
                    <input type="text" name="c_scontent" id="short-content" maxlength="200">
                </div>
                <div class="form__item short-form">
                    <label for="director">Руководитель</label>
                    <input type="text" name="c_director" id="director">
                </div>
                <div class="form__item short-form">
