        ...
        <div class="wrapper">
            <div class="posts">
                ...
                <div class="posts__item">
                    ...
                    <div class="content">
                        <a href="post_edit.php?post_id=<?=$post['id'];?>"><?=$post['title']?></a>
                        <small class="date"><?=$post['start']?></small>
                    </div>
                    <div class="options">
                        ...
                        <div class="click-handler">
                            <div class="options-list">
                                <div class="option edit">
                                    ...
                                    <a href="post_edit.php?post_id=<?=$post['id'];?>">Редактировать</a>
                                </div>
                                <div class="option add-image">
                                    <div class="icon"><img src="img/icons/image.png" alt="icon"></div>
                                    <a href="post_upload.php?post_id=<?=$post['id'];?>">Добавить изображение</a>
                                </div>
                                <div class="option delete">
                                    <div class="icon"><img src="img/icons/delete.png" alt="icon"></div>
                                    <a href="post_del.php?del_post=<?=$post['id'];?>">Удалить</a>
                                </div>
                            </div>
                        </div>
                    </div>
