...
if(isset($_POST['submit'])) {
    ...
    if($extension == 'jpg'||$extension == 'png'||$extension == 'gif') {        
        if ($fsize>=1000000) {
            ...
            $sql = "INSERT INTO attr(title, adult, child, time, places, age, ban, obligation, checkbox, img) VALUE('".$_POST['at_title']."','".$_POST['at_adult']."','".$_POST['at_child']."','".$_POST['at_time']."','".$_POST['at_places']."','".$_POST['at_age']."','".$_POST['at_ban']."','".$_POST['at_obligation']."','".$_POST['at_check']."','".$fnew."')";
...
<head>
    ...
    <title>Добавить аттракцион | Администратор ГПКиО</title>
</head>
<body>
    <header class="header">
    ...
    <nav class="navbar">
        ...
        <div class="navbar__item active">
            ...
            <a href="attr_add.php" class="add-new"><img src="img/icons/plus_active.png" alt="add-new"></a>
        </div>
        <div class="navbar__item">
        ...
        <div class="wrapper">
            <form class="form" action='' method='post' enctype="multipart/form-data">
                ...
                <div class="form__item forbid">
                    ...
                    <textarea name="at_ban" id="forbid"></textarea>
                </div>
                <div class="form__item resonse">
                    <label for="forbid">Посетитель обязан</label>
                    <textarea name="at_obligation" id="resonse"></textarea>
                </div>
