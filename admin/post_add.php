...
if(isset($_POST['submit'])) {
    ...
    if($extension == 'jpg'||$extension == 'png'||$extension == 'gif') {        
        if ($fsize>=1000000) {
            ...
            $sql = "INSERT INTO posts(title, scontent, content, start, img) VALUE('".$_POST['p_title']."','".$_POST['p_scontent']."','".$_POST['p_content']."','".$_POST['p_start']."','".$fnew."')";
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar__item active">
            ...
            <a href="post_add.php" class="add-new"><img src="img/icons/plus_active.png" alt="add-new"></a>
        </div>
        <div class="navbar__item">
        ...
        <div class="wrapper">
            <form class="form" action='' method='post' enctype="multipart/form-data">
                ...
                <div class="form__item">
                    ...
                    <textarea name="p_content" id="content"></textarea>
                </div>
                <div class="form__item">
