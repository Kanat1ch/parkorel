				...
				$fname = $_FILES['file']['name'];
					...
					{        
									if($fsize>=1000000)
										...
										{
												$sql = "update vacancy set title ='$_POST[v_title]', price ='$_POST[v_price]', claim ='$_POST[v_claim]', abligation ='$_POST[v_obligation]', img='$fnew' where id='$_GET[vacancy_id]'";  // update the submited data ino the database :images
...
<form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body container">
                                        ...
                                        <?php $ssql ="select * from vacancy where vacancy.id='$_GET[vacancy_id]'";
