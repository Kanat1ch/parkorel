...
<head>
    ...
    <title>Документы | Администратор ГПКиО</title>
        ...
        <div class="wrapper">
            <div class="posts">
                ...
                <div class="posts__item">
                    <div class="image">
                        <img src="img/vacancy/<?=$vacancy['img']?>" alt="image">
                    </div>
                    <div class="content">
                        <a href="vacancy_edit.php?vacancy_id=<?=$vacancy['id'];?>"><?=$vacancy['title']?></a>
                    </div>
                    <div class="options">
                        ...
                        <div class="click-handler">
                            <div class="options-list">
                                <div class="option edit">
                                    ...
                                    <a href="vacancy_edit.php?vacancy_id=<?=$vacancy['id'];?>">Редактировать</a>
                                </div>
                                <div class="option delete">
                                    <div class="icon"><img src="img/icons/delete.png" alt="icon"></div>
                                    <a href="vacancy_del.php?del_vacancy=<?=$vacancy['id'];?>">Удалить</a>
                                </div>
                            </div>
                        </div>
                    </div>
