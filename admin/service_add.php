...
if(isset($_POST['submit'])) {
    ...
    if($extension == 'jpg'||$extension == 'png'||$extension == 'gif') {        
        if ($fsize>=1000000) {
            ...
            $sql = "INSERT INTO services(title, content, phone, img) VALUE('".$_POST['s_title']."','".$_POST['s_content']."','".$_POST['s_phone']."','".$fnew."')";
...
<head>
    ...
    <title>Добавить услугу | Администратор ГПКиО</title>
</head>
<body>
    <header class="header">
        ...
        <div class="wrapper">
            <form class="form" action='' method='post' enctype="multipart/form-data">
                <div class="form__item short-form">
                    ...
                    <input type="text" name="s_title" id="title">
                </div>
                <div class="form__item short-form">
                    <label for="phone">Телефон</label>
                    <input type="text" name="s_phone" id="phone">
                </div>
                <div class="form__item">
                    <label for="content">Описание</label>
                    <textarea name="s_content" id="content"></textarea>
                </div>
                <div class="form__item">
