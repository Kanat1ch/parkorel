...
if(isset($_POST['submit'])) {
    ...
    if($extension == 'jpg'||$extension == 'png'||$extension == 'gif') {        
        if ($fsize>=1000000) {
            ...
            $sql = "INSERT INTO clubimg(cid, img) VALUE('".$cid."','".$fnew."')";
    ...
    <div class="container">
        <div class="wrapper">
            ...
            <form class="form" action='' method='post' enctype="multipart/form-data">
                <h2>Редактирование изображений клуба "<?=$row['title']?>"</h2>
                ...
                <div class="image-container">
                    <?php foreach ($cimg as $cimgs):?>
                        <div class="image-item">
                            <img src="img/clubs/<?=$cimgs['img']?>" alt="image">
                            <div class="loupe"></div>
                            <a href="clubimg_del.php?del_clubimg=<?=$cimgs['id'];?>">Удалить</a>
                        </div>
                    <?php endforeach; ?>
                </div>
            </form>
