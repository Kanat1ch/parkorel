				...
				$fname = $_FILES['file']['name'];
					...
					{        
									if($fsize>=1000000)
										...
										{
												$sql = "update clubs set title ='$_POST[c_title]', director ='$_POST[c_director]', phone ='$_POST[c_phone]', content ='$_POST[c_content]',  img='$fnew' where id='$_GET[club_id]'"; 
...
<form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body container">
                                        ...
                                        <?php $ssql ="select * from clubs where clubs.id='$_GET[club_id]'";
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-danger">
                                        ...
                                        <input type="text" name="c_director" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row p-t-20">
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-12">
                                    <div class="form-group has-danger">
                                        <label class="control-label">Остальная информация</label>
                                        <textarea id="mytextarea" name="c_content" class="form-control form-control-danger"></textarea>
                                    </div>
                                </div>
