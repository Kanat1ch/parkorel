...
session_start();
$sid = $_GET['service_id'];
$ssql ="select * from services where services.id='$_GET[service_id]'";
...
if(isset($_POST['submit'])) {
    ...
    $store = "img/services/".basename($fnew);                  
    if($extension == 'jpg'||$extension == 'png'||$extension == 'gif') {        
        if ($fsize>=1000000) {
            ...
            $sql = "update services set title ='$_POST[s_title]', content ='$_POST[s_content]', phone ='$_POST[s_phone]', img='$fnew' where id='$_GET[service_id]'";
    ...
    header("location:service_edit.php?service_id=$sid");
}
?>
<head>
    <meta charset="UTF-8">
        ...
        <div class="wrapper">
            <form class="form" action='' method='post' enctype="multipart/form-data">
                <div class="form__item short-form">
                    ...
                    <input type="text" name="s_title" id="title" value="<?=$row['title']?>">
                </div>
                <div class="form__item short-form">
                    <label for="phone">Телефон</label>
                    <input type="text" name="s_phone" id="phone" value="<?=$row['phone']?>">
                </div>
                <div class="form__item">
                    <label for="content">Описание</label>
                    <textarea name="s_content" id="content"><?=$row['content']?></textarea>
                </div>
                <div class="form__item">
