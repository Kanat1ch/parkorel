...
let elementSize = 0 ;
const elements = document.querySelectorAll('h1, h2, h3, a, p, span, .attr__info-item_text, .attr__item-title, .attr__info i.fa');
const elementsBorder = document.querySelectorAll('.header-vi li, .attr__info, .attr__item');
