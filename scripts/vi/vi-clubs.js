...
let elementSize = 0 ;
const elements = document.querySelectorAll('h1, h2, h3, a, p, span, .attr__info, .clubs__item-title');
const elementsBorder = document.querySelectorAll('.header-vi li, .clubs__info, .clubs__item');
