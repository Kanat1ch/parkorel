...
let elementSize = 0 ;
const elements = document.querySelectorAll('h1, h2, h3, a, p, span, .partners__item-title');
const elementsBorder = document.querySelectorAll('.header-vi li, .partners__item');
